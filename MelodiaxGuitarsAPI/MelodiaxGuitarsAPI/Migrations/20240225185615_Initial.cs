        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SidesAndBack = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Neck = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Nut = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Fingerboard = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Strings = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Tuners = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PickupSwitch = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cutaway = table.Column<bool>(type: "bit", nullable: false),
                    Pickguard = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Case = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScaleLength = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubtotalCost = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    Shipping = table.Column<bool>(type: "bit", nullable: false),
                    ShippingCost = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
